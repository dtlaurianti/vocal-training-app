...
class Pattern(Base):
    ...
    name = mapped_column(String(25))
    abbr = mapped_column(String(10))
    degrees = mapped_column(String(20)) # ^3^5^1v5v3, etc.
...
session.add_all([
    ...
    Pattern(name='Arpeggio Up', abbr='MArpU', scale_id=1, intervals='^M3^m3'),
    Pattern(name='Arpeggio Down', abbr='ArpD', scale_id=1, intervals='^m3^M3')
])
